...
/***/ (function(module, exports, __webpack_require__) {
	...
	var quoteEvents = __webpack_require__(13);
	var visible = __webpack_require__(12);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://quiet-island-36585.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateAccount = function onCreateAccount(event) {
	  ...
	  api.createAccount(data).then(ui.createAccountSuccess).catch(ui.createAccountFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createAccountSuccess = function createAccountSuccess(data) {
	  ...
	  api.login({ credentials: credentials }).then(loginSuccess).catch(loginFailure);
	  visible.clearFormFields();
	  $('#cr-acct-success-alert').alert();
	  $('#cr-acct-success-alert').fadeTo(1500, 500).slideUp(500, function () {
	    $('#cr-acct-success-alert').slideUp(500);
	  });
	};

	var createAccountFailure = function createAccountFailure(error) {
	  var errTextExists = error.responseJSON;
	  if (errTextExists.password) {
	    $('#cr-acct-fail-alert-blank').alert();
	    $('#cr-acct-fail-alert-blank').fadeTo(1500, 500).slideUp(500, function () {
	      $('#cr-acct-fail-alert-blank').slideUp(500);
	    });
	  } else {
	    $('#cr-acct-fail-alert-exists').alert();
	    $('#cr-acct-fail-alert-exists').fadeTo(1500, 500).slideUp(500, function () {
	...
	var loginFailure = function loginFailure(error) {
	  ...
	  $('#login-fail-alert').fadeTo(1500, 500).slideUp(500, function () {
	...
	var changePasswordSuccess = function changePasswordSuccess(data) {
	  ...
	  $('#ch-pass-success-alert').fadeTo(1500, 500).slideUp(500, function () {
	...
	var changePasswordFailure = function changePasswordFailure(error) {
	  ...
	  $('#change-pass-fail-alert').fadeTo(1500, 500).slideUp(500, function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onDocLoad = function onDocLoad() {
	  $('.alert').hide();
	  $('#change-pass-form').hide();
	  $('#logout-btn').hide();
	  $('#create-quote-form').hide();
	...
	var onSafeSpace = function onSafeSpace() {
	  $('#safe-space-gif').show();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateQuote = function onCreateQuote(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.createQuote(data).then(ui.createQuoteSuccess).catch(ui.createQuoteFailure);
	};

	var onGetQuotes = function onGetQuotes(event) {
	  api.readQuotes().then(ui.getQuotesSuccess).catch(ui.getQuotesFailure);
	};
	...
	var onUpdateQuote = function onUpdateQuote(event) {
	  ...
	  api.updateQuote(id, data).then(ui.updateQuoteSuccess).catch(ui.updateQuoteFailure).done(onGetQuotes);
	};

	var onDeleteQuote = function onDeleteQuote(event) {
	  event.preventDefault();
	  var id = $(this).attr('data-id');
	  api.deleteQuote(id).then(ui.deleteQuoteSuccess).catch(ui.deleteQuoteFailure).done(onGetQuotes);
	};

	var onGetAllQuotes = function onGetAllQuotes(event) {
	  event.preventDefault();
	  api.readAllQuotes().then(ui.getAllQuotesSuccess).catch(ui.getQuotesFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateQuote = function updateQuote(id, data) {
	  return $.ajax({
	...
	var readQuotes = function readQuotes() {
	  return $.ajax({
	...
	var readAllQuotes = function readAllQuotes() {
	  return $.ajax({
	    url: config.apiOrigin + '/quotes/',
	    method: 'GET',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showQuotes = __webpack_require__(16);
	var showAllQuotes = __webpack_require__(36);

	var store = __webpack_require__(10);
	var visible = __webpack_require__(12);

	var createQuoteSuccess = function createQuoteSuccess(data) {
	  store.quote = data.quote;
	  $('#cr-quote-success-alert').alert();
	  $('#cr-quote-success-alert').fadeTo(1500, 500).slideUp(500, function () {
	    $('#cr-quote-success-alert').slideUp(500);
	  });
	  visible.clearFormFields();
	};

	var createQuoteFailure = function createQuoteFailure(error) {
	  console.error(error);
	  $('#cr-quote-fail-alert').alert();
	  $('#cr-quote-fail-alert').fadeTo(1500, 500).slideUp(500, function () {
	    $('#cr-quote-fail-alert').slideUp(500);
	  });
	};

	var getQuotesSuccess = function getQuotesSuccess(data) {
	  visible.clearFormFields();
	  var showQuotesHTML = showQuotes({ quotes: data.quotes });
	  $('.render-quotes').html(showQuotesHTML);
	};

	var getQuotesFailure = function getQuotesFailure(data) {};
	...
	var updateQuoteFailure = function updateQuoteFailure(error) {
	  console.error(error);
	};
	...
	var deleteQuoteFailure = function deleteQuoteFailure(error) {
	  console.error(error);
	};

	var getAllQuotesSuccess = function getAllQuotesSuccess(data) {
	  var showQuotesHTML = showAllQuotes({ quotes: data.quotes });
	  $('.render-quotes').html(showQuotesHTML);
	};

	module.exports = {
	  createQuoteSuccess: createQuoteSuccess,
	  createQuoteFailure: createQuoteFailure,
	  getQuotesSuccess: getQuotesSuccess,
	  getQuotesFailure: getQuotesFailure,
	  ...
	  getAllQuotesSuccess: getAllQuotesSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "   <ul data-id=\""
	    ...
	    + "</li>\n     <li> Quote: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.quote_text : stack1), depth0))
	    + "</li>\n     <button type=\"button\" class=\"btn btn-danger\" id=\"update-quote-btn\" data-toggle=\"modal\" data-target=\"#update"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" > Update Review </button>\n     <button type=\"button\" class=\"del-btn btn btn-danger\" id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"> Delete Quote </button>\n   </ul>\n\n\n<!-- update quote modal -->\n<div class=\"upModal modal fade\" id=\"update"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-hidden=\"true\">\n      <div class=\"modal-dialog\" role=\"document\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <h5 class=\"modal-title\">Update This Quote</h5>\n          </div>\n          <div class=\"modal-body\">\n            <form id=\"update-quote-form\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n            <fieldset>\n              <input type='text' name='quote[quote_text]'placeholder=\"Updated Quote Text\">\n              <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" name=\"submit\" value=\"Update This Quote\">\n          </fieldset>\n          </form>\n          </div>\n          <div class=\"modal-footer\">\n            <div class=\"updateerror\"></div>\n            <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Close</button>\n          </div>\n        </div>\n      </div>\n    </div>\n\n    <!-- delete quote modal -->\n    <!-- <div class=\"delModal modal fade\" id=\"delete"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-hidden=\"true\">\n          <div class=\"modal-dialog\" role=\"document\">\n            <div class=\"modal-content\">\n              <div class=\"modal-header\">\n                <h5 class=\"modal-title\">Are you sure???</h5>\n              </div>\n              <div class=\"modal-body\">\n                <form id='del-quote-form' data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n                <fieldset>\n                  <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" name=\"submit\" value=\"Delete This Quote\">\n              </fieldset>\n              </form>\n              </div>\n              <div class=\"modal-footer\">\n                <div class=\"updateerror\"></div>\n                <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Close</button>\n              </div>\n            </div>\n          </div>\n        </div> -->\n\n";
